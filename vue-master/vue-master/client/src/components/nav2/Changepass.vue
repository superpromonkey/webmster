<template>
    ...
    <el-form-item label="当前密码：" label-width="100px">
            <el-input type="password"  v-model="psd"   class="my-inwt" ></el-input>
    </el-form-item>
    <el-form-item label="新密码：" label-width="100px">
            <el-input type="password" v-model="newpwd"  @blur="escle"  class="my-inwt" ></el-input>
    </el-form-item>
    <el-form-item label="确认密码：" label-width="100px">
            <el-input type="password"  v-model="delpwd"  @blur="miscle"   class="my-inwt" ></el-input>
    </el-form-item >
     <el-form-item label-width="100px">
        <el-button type="primary"  @click="togo" >确认修改</el-button>
    </el-form-item>
    </el-form>
    </div>
</template>
