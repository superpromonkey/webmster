<template>
    <div id="goodskind" >
         <el-button @click="open3" type="primary">添加</el-button>
      <div class="table">
            <el-table
                border
                ref="multipleTable"
               ...
               >
                ...
                width="200">
                    <template slot-scope="scope">
                        <el-button  size="mini" @click="handleClick(scope.row)"  icon="el-icon-edit">编辑</el-button>
    ...
    <!-- 添加商品分类 -->
     <div class="mack" v-if="newShow">
          <el-form class="userform" style="border: 1px solid #ccc;padding:10px 20px;">
               <el-form-item label="添加商品分类的名字:">
                    <el-input type="text" id="goodsname" v-model="resetname" placeholder="输入添加的商品分类" ></el-input>
                </el-form-item>
                 <el-button   @click="resetName" type="primary" >添加</el-button>
